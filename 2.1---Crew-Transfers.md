...
You can move a kerbal from seat to seat within the same part, or transfer a kerbal to another part within your vessel.  If the target part (or seat) is full, then the source kerbal will swap places with the first kerbal in the target part (or seat).
...
*Warning:* When transferring multiple crew members using the "Vessel" selection, KIS inventory may be lost.
...
During the transfer, the Xfer button will be replaced with the word "Moving" for all kerbals being moved. All other Xfer buttons will be grayed out. Once complete, the Portraits will update and all Xfer buttons will again be active.
