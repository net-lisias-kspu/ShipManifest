...
The SMInterface.dll is designed to reside in your plugins folder.  Create a reference to the dll, and then make a call to interrogate the provided bool _IsSMInstalled_ to determine if Ship Manifest is installed.
...
Once you have established that ShipManifest is installed you can call _GetCrewTransfer()_ to obtain an instance of the ICrewTransfer Object and interrogate the properties provided.
